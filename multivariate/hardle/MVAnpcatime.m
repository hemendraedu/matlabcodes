...
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       PCA for the standardized time budget data 
%               ("timebudget.dat") and shows the first two principal 

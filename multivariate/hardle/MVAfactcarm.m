...
% ---------------------------------------------------------------------
% Description:  MVAfactcarm performs a factor analysis for the car 
%                marks data ("carmean.dat") and shows the eigenvalues of 
%                r-psi and a plot of the factor loadings for the first 
%                two factors.
% ---------------------------------------------------------------------
% Usage:        MVAfactcarm
% ---------------------------------------------------------------------

...
% ---------------------------------------------------------------------
% Description:  MVAcorrcrime performs a correspondence analysis for the 
%                US crime ("uscrime.dat"), shows the eigenvalues of the
...
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Correspondence analysis for the US crime 
%               ("uscrime.dat"), shows the eigenvalues of the singular
...
for i=1:7
    text(ss(i,1),ss(i,2),crime(i,1:3),'Color','r');
end;
...
state=['ME'
       ...
       'HI'];
for i=1:50
    text(rr(i,1),rr(i,2),state(i,1:2),'Color','b');
end;
title('US Crime Data');
xlabel('r_1,s_1');
ylabel('r_2,s_2');

...
% ---------------------------------------------------------------------
% Description:  MVAnpcabank performs PCA for the STANDARDIZED Swiss 
%               bank notes ("bank2.dat") data and shows the first three 
...
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Performs PCA for the STANDARDIZED Swiss bank notes 
%               ("bank2.dat") data and shows the first three principal 

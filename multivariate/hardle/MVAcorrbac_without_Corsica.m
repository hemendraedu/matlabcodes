...
xlabel('r_1,s_1');
ylabel('r_2,s_2');
line([-0.4 0.3],[0 0],'Color','k')
line([0 0],[0.3 -0.4],'Color','k')
regions=['ildf'
       'cham'
       'pica'
       'hnor'
...
for i=1:length(x)
    text(rr(i,1),rr(i,2),regions(i,1:4),'Color','b');
end
...
for i=1:8
     text(ss(i,1),ss(i,2),modalities(i,1),'Color','r','Fontsize',14);
end
